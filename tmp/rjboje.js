/* rjboje.js v3 (20260923g) — kutije boja istog modela uz „Odaberi boju:" na stranici bicikla / e-bicikla.
   Izvor: /user_files/rjboje.json v2 (gradi boje_build.py iz skena javnih stranica + prodaje po šifri iz xMPWEB):
     ...
     a[wid] = {h: url, n: naziv, c: [temine hex], x: hex iz fotke, s: 1 ako postoji izrez /user_files/rjboja-<wid><_suf>.webp, q: prodano}; _suf = '' (čista boja) ili '-w' (širi izrez s logom).
